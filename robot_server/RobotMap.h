...
class RobotMap
{
  public:
    ...
    void useTheseScanData(std::vector<A3dpoint> points){};
    int getCurrentRobotID(){return 1;};
    double getCurrentRobotX(){return 0;};
    double getCurrentRobotY(){return 0;};
    ...
    void updateRobotMap(int **map){return;};
